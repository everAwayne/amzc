...
class AMZITProductInfo(AMZProductInfo):
    ...
    def is_fba(self):
        ...
        if 'spedito da amazon' in fba_info:
            return True
        return False
    ...
    def get_product_info(self):
        ...
        if div1:
            ...
            if li_ls:
                ...
                reg_res = re.search(r'n\.\s*([\d.]+)\s+in\s+(.+)\(', text)
                if reg_res:
